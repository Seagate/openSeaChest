...
# ******************************************************************************************
#
# \file platforms/openbsd.mk
# \brief OpenBSD platform-specific configuration (limited ATA support)
...
# OpenBSD: Limited to 28-bit ATA commands only
# No NVMe support
ENABLE_NVME := 0
...
vpath %.c $(TRANSPORT_DIR)/src/openbsd
